  ...
  landing: {
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          answer: "それを確認するのが、無料のAIオーディットです。費用をいただく前に、あなたのビジネス、ツール、業務フローを分析します。AIが実際の価値をもたらせないと判断した場合は、正直に伝えます——オーディットレポートはどちらにせよあなたのものです。確信が持てなければ引き受けません。",
        },
        {
          question: "AIコンサルタントを雇うことと、何が違うのですか？",
          answer: "多くのコンサルタントは戦略資料を渡して終わりです。わたしたちはあなたと一緒に動くシステムをつくり、チームが自力で運用できるようにトレーニングします。プロジェクトが終わるころには、わたしたちは不要になっています。それが目標です。オーナーシップ保証がそれを契約で保証します。",
        },
        {
          question: "最終的に、私たちは何を「所有」することになりますか？",
          answer: "すべてです。データはあなたのシステムに残ります。エージェントはあなたのインフラで動きます。ワークフローはあなたの自動化プラットフォーム（n8n、自己ホスト）で動きます。ドキュメントはあなたのファイルストレージに保存されます。明日契約を終了しても、すべてがそのまま動き続けます。",
        },
        {
        ...
        },
        {
          ...
          answer: "完全にドキュメント化され、稼働中のAIオペレーティングシステムを所有することになります。チームが自力で運用・拡張できます。継続的な戦略支援が必要なら、月額¥50,000からのAI顧問サービスもあります——プレッシャーなし、自動更新なし。",
        },
        {
          question: "ITプロジェクトで予算超過・納期遅延を経験してきました。何が違うのですか？",
          answer: "固定スコープ、固定価格、固定期間です。月額¥200,000×6ヶ月。毎週一緒に作業しているため、範囲が広がりにくく、変更が必要な場合はオープンに話し合います。オーナーシップ保証は、わたし自身が納品に責任を持つという意味です。",
        },
        {
    ...
    beforeAfter: {
      ...
      with: [
        ...
        "朝目が覚めると、今日やるべきことがシステムからスッと届いている",
    ...
    program: {
      ...
      subtitle: "棚に置かれるだけのパワーポイントではありません。チームと一緒に、ずっと所有できるインフラをつくります。",
      month1: {
        title: "調査・計画",
        subtitle: "1ヶ月目",
        items: [
