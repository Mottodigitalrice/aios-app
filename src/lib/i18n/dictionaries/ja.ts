const ja = {
  ...
  landing: {
    ...
    pricing: {
      badge: "ローンチ価格 — 先着3社限定",
      title: "永遠に所有するインフラへの投資。",
      subtitle:
        "2つのプラン。どちらもフルプログラムとオーナーシップ保証付き。",
      spotsLeft: "今四半期の残り枠はあと2社",
      monthly: "月額",
      monthlyPrice: "¥200,000",
      monthlyPer: "/月",
      monthlyTotal: "¥200,000 × 6 = ¥1,200,000 総額",
      monthlyCta: "月払いで始める",
      payInFull: "一括払い",
      payInFullPrice: "¥1,000,000",
      payInFullSave: "月払いより¥200,000お得",
    ...
    guarantee: {
      title: "オーナーシップ保証",
      description: "6ヶ月のプログラムを完走してください。6ヶ月目終了時点で、チームがAIエージェントを自力で作成・管理できない場合、できるようになるまで無償でサポートを継続します。",
      refund: "",
    },
    pricingDetails: {
