...
const auditV2DictJa: AuditV2Dictionary = {
  ...
  badge: "AI監査 · 無料",
  title: "エージェンティックAIが御社に",
  titleHighlight: "役立つか、どう役立つか。",
  subtitle:
    "クイズではなく、本格的な診断です。所要時間約5分。代表のLewisが直接ご回答を分析し、2営業日以内にあなた専用のレポートをお送りします。その後、無料30分の通話で一緒に内容をご説明します。営業は一切ありません。",
  chips: ["専用レポート", "無料30分ウォークスルー", "営業は一切なし"],
  common: {
    back: "戻る",
    continue: "次へ",
    submit: "送信する",
  ...
  email: {
    question: "レポートの送り先を教えてください。",
    description: "Lewisのレビュー後、こちらのアドレスに御社専用のレポートをお送りします。",
    label: "メールアドレス",
    placeholder: "you@company.com",
    hint: "Lewisが直接すべてのご回答をレビューし、2営業日以内にご返信します。スパムは一切ありません。",
  },
  goals: {
    select: {
  ...
  popup: {
    ...
    body:
      "Mottodigital代表のLewisが直接、お客様のご回答を分析し、**2営業日以内**にあなた専用のレポートをお送りします。",
    bodyConsult:
      "次に、**無料30分のウォークスルー**をご予約ください。レポートの内容を一緒に確認します。",
    promise:
      "私たちの約束: 営業はいたしません。通話で売り込むことはなく、ご希望がない限り「どうお手伝いできるか」もお伝えしません。御社の現在地を一緒に確認するだけです。",
    cta: "無料30分ウォークスルーを予約する",
  ...
  sidebar: {
    ...
    steps: {
      email: {
        title: "レポートの送り先",
        items: ["Lewisが直接すべてレビュー", "2営業日以内にご返信・スパムなし"],
      },
      goals: {
        title: "目標起点の監査",
        items: [
