const signupDict = {
  ...
  steps: {
    1: {
      ...
      cohortPrice: "¥20,000/month (excl. tax)",
      cohortDescription:
      ...
      individualPrice: "¥50,000/month (excl. tax)",
      ...
      companyPrice: "¥200,000/month (excl. tax)",
      companyDescription:
    ...
    8: {
      ...
      trackLabel: "Track",
      trackCohort: "Group Cohort (¥20,000/mo, excl. tax)",
      trackIndividual: "One-on-One (¥50,000/mo, excl. tax)",
      trackCompany: "Company Build (¥200,000/mo, excl. tax)",
      nameLabel: "Name",
      emailLabel: "Email",
      ...
      paymentMonthly: "Monthly — ¥20,000/mo × 6 (before tax)",
