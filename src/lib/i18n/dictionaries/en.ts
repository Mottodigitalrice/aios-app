const en = {
  ...
  landing: {
    ...
    pricing: {
      ...
      subtitle:
        "Two ways to get started. Both include the full program and the Ownership Guarantee.",
      spotsLeft: "Only 2 spots remaining this quarter",
      monthly: "Monthly",
      monthlyPrice: "\u00A5200,000",
      monthlyPer: "/mo",
      monthlyTotal: "\u00A5200,000 \u00D7 6 = \u00A51,200,000 total",
      monthlyCta: "Start Monthly",
      payInFull: "Pay in Full",
      payInFullPrice: "\u00A51,000,000",
      payInFullSave: "Save \u00A5200,000 vs monthly",
    ...
    guarantee: {
      ...
      description: "Complete the full 6-month program with us. If by Month 6 your team can\u2019t independently create and manage AI agents without our help, we\u2019ll continue working with you at zero cost until they can.",
      refund: "",
    },
    pricingDetails: {
