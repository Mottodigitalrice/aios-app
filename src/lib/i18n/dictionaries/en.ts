  ...
  landing: {
    ...
    pricing: {
      ...
      cohort: {
        ...
        bestFor: [
          "Learn alongside other AI-forward professionals",
          "Collaborative learning with shared problem-solving",
          "Same AIOS curriculum in a peer group setting",
          "Great entry point if you\u2019re still exploring what\u2019s possible",
        ],
      },
      oneOnOne: {
        ...
        bestFor: [
          "CEOs, executives, managers, and solopreneurs",
          "Clear business model with proven workflows ready to scale",
          "Dedicated 1-on-1 coaching tailored to your specific business",
          "High conviction on AI \u2014 you want to be on the front lines",
        ],
      },
      company: {
        label: "Team Training",
        ...
        bestFor: [
          "Companies that want to be early adopters of agentic AI",
          "Build a team of up to 10 internal AI experts",
          "Stop relying on external AI consultants \u2014 own it internally",
          "Full organizational AI transformation",
        ],
      },
