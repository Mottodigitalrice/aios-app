const signupDict = {
  ...
  steps: {
    ...
    8: {
      ...
      trackLabel: "トラック",
      trackCohort: "グループコホート（¥20,000/月・税抜）",
      trackIndividual: "マンツーマン（¥50,000/月・税抜）",
      trackCompany: "カンパニービルド（¥200,000/月・税抜）",
      nameLabel: "氏名",
      emailLabel: "メール",
      companyLabel: "会社名",
      roleLabel: "役職",
      ...
      paymentMonthly: "月額 — ¥20,000/月 × 6（税抜）",
