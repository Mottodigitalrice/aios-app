const auditDict = {
    ...
    steps: {
      ...
      1: {
        ...
        items: [
          ...
          "50社以上の企業・専門家が監査を受けました",
          "導入後約40%の効率向上",
        ],
        testimonial: {
          quote:
            "監査のおかげで、考えもしなかった自動化の機会に気づきました。ぜひ試してみてください。",
          author: "T.M.",
          role: "CEO、テックスタートアップ",
        },
      },
      ...
      6: {
        ...
        highlight:
          "監査を受けた約85%が初月から導入を開始しています。",
      },
      7: {
        title: "もう少しで完了",
        items: [
          "48時間以内にカスタム監査レポートを届けます",
          "営業なし、義務なし",
          "完全なレポートはずっとあなたのものです",
        ],
      },
  ...
  steps: {
    ...
    2: {
      ...
      perspectiveLabel: "この監査はどの観点で行いますか？",
