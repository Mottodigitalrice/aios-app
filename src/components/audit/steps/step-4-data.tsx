      ...
      <div className="space-y-8">
        ...
        {isIndividual && (
          <div className="space-y-2">
            <Label htmlFor="typicalDay" className="text-[#6E6E73]">
        ...
        <div className="space-y-3">
          <Label className="text-[#6E6E73]">{step.maturityLabel}</Label>
        ...
        {isCompanyOrDept && (
          <div className="space-y-3">
            <Label className="text-[#6E6E73]">{step.confidenceLabel}</Label>
            <div className="space-y-2">
        ...
        <div className="space-y-3">
          <Label className="text-[#6E6E73]">{step.dataLocationLabel}</Label>
          <MultiSelectChips
        ...
        {isCompanyOrDept && (
          <div className="space-y-3">
            <Label className="text-[#6E6E73]">{step.restructuringLabel}</Label>
            <div className="grid grid-cols-1 gap-2">
        ...
        {isCompanyOrDept && (
          <div className="space-y-3">
            <Label className="text-[#6E6E73]">{step.processDocLabel}</Label>
            <div className="grid grid-cols-1 gap-2">
        ...
        {isDepartment && (
          <div className="space-y-3">
            <Label className="text-[#6E6E73]">{step.toolAutonomyLabel}</Label>
            <div className="grid grid-cols-1 gap-2">
