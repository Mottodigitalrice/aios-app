        ...
        <div className="mx-auto max-w-2xl px-6">
          ...
          <div className="rounded-xl border border-[#E8E8ED] bg-[#F5F5F7] p-6 mb-8">
            <div className="flex items-start gap-3 mb-3">
              <CalendarCheck className="size-5 text-[#B8860B] shrink-0 mt-0.5" />
              <h3 className="text-base font-semibold text-[#1D1D1F]">
                {s.optionalBookingTitle}
              </h3>
            </div>
            <p className="text-sm text-[#6E6E73] leading-relaxed mb-4">
              {s.optionalBookingBody}
            </p>
            <a
              href="https://tidycal.com/rice/aios-consult"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-lg border border-[#B8860B]/30 bg-white text-[#B8860B] px-4 py-2 text-sm font-medium hover:bg-[#B8860B]/5 transition-colors"
            >
              <CalendarCheck className="size-4" />
              {s.optionalBookingCta}
            </a>
          </div>
