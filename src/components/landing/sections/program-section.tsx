        ...
        <AnimateInView>
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="flex size-10 items-center justify-center rounded-full bg-indigo-500/20 text-indigo-300 font-bold text-sm">1</div>
              <div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <AnimateInView delay={100}>
            <div className="rounded-xl p-8 h-full" style={{ backgroundColor: "var(--lp-bg-elevated)", border: "1px solid var(--lp-border-visible)" }}>
              <div className="flex items-center gap-3 mb-6">
                <div className="flex size-10 items-center justify-center rounded-full bg-indigo-500/20 text-indigo-300 font-bold text-sm">2</div>
                <div>
          ...
          <AnimateInView delay={200}>
            <div className="rounded-xl p-8 h-full" style={{ backgroundColor: "var(--lp-bg-elevated)", border: "1px solid var(--lp-border-visible)" }}>
              <div className="flex items-center gap-3 mb-6">
                <div className="flex size-10 items-center justify-center rounded-full bg-indigo-500/20 text-indigo-300 font-bold text-sm">3</div>
                <div>
          ...
          <AnimateInView delay={300}>
            <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-8 h-full">
              <div className="flex items-center gap-3 mb-6">
                <div className="flex size-10 items-center justify-center rounded-full bg-emerald-500/20 text-emerald-300 font-bold text-sm">4-6</div>
                <div>
