...
export function LanguageToggle({ locale, onToggle }: LanguageToggleProps) {
  return (
    <button
      ...
      className="flex items-center gap-1.5 rounded-full border border-zinc-700/50 bg-zinc-800/50 px-3 py-2 min-h-[44px] min-w-[44px] text-xs font-medium text-zinc-400 hover:text-zinc-200 hover:border-zinc-600 transition-colors"
